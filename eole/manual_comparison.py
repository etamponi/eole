...
def main():
    ...
    report_rf = Report.load("evaluation/reports/{}_small_random_forest.rep".format(dataset_name))
    ...
    for dataset_path in glob.glob("evaluation/reports/{}_small_eole*.rep".format(dataset_name)):
